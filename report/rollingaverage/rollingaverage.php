...
function getObjectsbyEntity()
{
   ...
   foreach ($CFG_GLPI["asset_types"] as $key => $itemtype) {
      ...
      if ($itemtype == 'Computer') {
         ...
         if (count($query) > 0) {
            if (!$display_header) {
               echo "<div class='alert alert-primary mt-3 text-center'>This report lists the rolling average of each group's asset reservation over 9 weeks. Each data point is an average of the previous 9 weeks</div>";
