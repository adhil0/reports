...
function plugin_init_reports() {
   ...
   $PLUGIN_HOOKS['add_javascript']['reports'][] = 'datatables.min.js';
   $PLUGIN_HOOKS['add_javascript']['reports'][] = 'customDatatables.js';
   $PLUGIN_HOOKS['add_css']['reports'] = 'datatables.min.css';
   $rightreport = [];
   $rightstats  = [];
